...
#define PACKET1_STATIC_LENGTH            (12UL)  //!< static length in bytes
#define PACKET1_PAYLOAD_SIZE             (12UL)  //!< payload size in bytes
//#define PACKET1_PAYLOAD_SIZE             (4UL)  //!< payload size in bytes
...
void radio_configure()
{
  ...
  /******************shortcut enable for no delay(by sipark)***********************************************/
  ...
  NRF_RADIO->SHORTS = (RADIO_SHORTS_DISABLED_TXEN_Enabled << RADIO_SHORTS_DISABLED_TXEN_Pos);
 /*****************************************************************************************/
